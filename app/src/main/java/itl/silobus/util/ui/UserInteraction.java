...
public class UserInteraction {
    ...
    /**
     * @param text the resource of text to show
     */
    ...
    public void showSnackBarWithAction(String text, int duration, String textAction,
                                       View.OnClickListener clickListener) {
        Snackbar snackbar = Snackbar
                .make(((AppCompatActivity) mContext).findViewById(android.R.id.content),
                        text, duration).setAction(textAction, clickListener);
        snackbar.show();
    }
